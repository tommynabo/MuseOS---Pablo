                        ...
                        <div className="flex flex-col items-center justify-center mb-8 relative h-24 w-full">
                            <div className="relative z-10 w-full h-full flex items-center justify-center">
                                <button
                                    ...
                                    className="text-7xl font-bold text-slate-800 tracking-tighter hover:text-blue-700 transition-colors select-none"
                                >
                                    {schedTime}
                                </button>
                            </div>
                            ...
                            {showTimePicker && (
                                <div className="absolute top-24 z-50 bg-white border-2 border-blue-200 rounded-2xl shadow-2xl p-6 w-80">
                                    <div className="grid grid-cols-2 gap-6">
                                        {/* Hours */}
                                        <div>
                                            <label className="text-xs font-bold text-slate-400 uppercase mb-3 block text-center">Horas</label>
                                            <div className="bg-slate-50 rounded-xl p-2 h-64 overflow-y-auto custom-scrollbar">
                                        ...
                                        {/* Minutes */}
                                        <div>
                                            <label className="text-xs font-bold text-slate-400 uppercase mb-3 block text-center">Minutos</label>
                                            <div className="bg-slate-50 rounded-xl p-2 h-64 overflow-y-auto custom-scrollbar">
                                                <div className="space-y-2">
