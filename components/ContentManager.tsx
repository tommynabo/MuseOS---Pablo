  ...
  return (
    <div className="max-w-[1600px] mx-auto p-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start h-[calc(100vh-200px)]">
        ...
        {/* LEFT COLUMN: IDEAS (Backlog) - Scrollable */}
        ...
        {/* RIGHT COLUMN: CONTENT ROOM (Drafts & Ready) - Scrollable */}
        <div className="lg:col-span-2 flex flex-col gap-6 h-full overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
                
                {/* DRAFTS SECTION */}
                <div className="bg-white rounded-[32px] p-6 border border-gray-100 shadow-sm h-full flex flex-col">
                    <SectionHeader 
                        icon={Clock} 
                        title="Borradores" 
                        count={drafts.length} 
                    ...
                    <div className="space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar pb-4">
                        ...
                        <div 
                            ...
                            className="bg-gray-50 p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:bg-white hover:border-indigo-100 transition-all cursor-pointer group"
                        >
                ...
                <div className="bg-white rounded-[32px] p-6 border border-gray-100 shadow-sm h-full flex flex-col">
                    ...
                    <div className="space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar pb-4">
                        {ready.map(item => (
                        <div key={item.id} className="bg-gray-50 p-5 rounded-2xl border border-gray-100 shadow-sm hover:bg-white transition-all cursor-default">
